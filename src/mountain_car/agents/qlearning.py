...
class QLearningAgent:
    ...
    def discretize(self, obs: np.ndarray) -> tuple:
        ...
        """
        # Cada índice indica en qué intervalo cayó una dimensión del estado.
    ...
    def select_action(self, state: tuple, *, deterministic: bool = False) -> int:
        ...
        """
        # En evaluación se fuerza la acción con mayor valor y no se explora.
    ...
    def _update(
        ...
        """
        # Al llegar al objetivo no se debe estimar un estado siguiente.
